              ...
              {filteredDocs.length === 0 ? (
                ...
                filteredDocs.map(doc => (
                  <button
                    ...
                    className="w-full text-left px-2.5 py-2 rounded-lg hover:bg-white flex items-center gap-2.5 transition-colors duration-150 group border border-transparent hover:border-gray-200"
                  >
                    <div className="w-7 h-7 rounded-lg bg-white border border-gray-200 flex items-center justify-center flex-shrink-0 group-hover:border-gray-300 transition-all">
